...
");
?>
<h1>PrefixModel Generator</h1>

<p>This generator generates a model class for the specified database table, and allows a model prefix when you generate
    models for all tables.</p>
